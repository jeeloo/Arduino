...
//Feather Huzza & NeoPixel Stick 8 & Pir
...
void loop() {
  ...
  if (val == HIGH) {            // check if the input is HIGH
    ...
    theaterChase(strip.Color(139, 0, random(139)), 50);
    //rainbowCycle(20);
    if (pirState == LOW) {
    ...
    theaterChase(strip.Color(255, 255, 51), 150);
    if (pirState == HIGH){
